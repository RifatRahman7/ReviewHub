    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-green-950 to-black text-white">
      ...
      <div className="flex-grow px-4 sm:px-6 lg:px-10 py-16 max-w-7xl mx-auto roboto">
        ...
        <div className="overflow-x-auto bg-black bg-opacity-50 rounded-md shadow-md">
          <table className="min-w-full table-auto border border-green-700 text-sm sm:text-base md:text-lg text-white">
              ...
              {myServices.map(service => (
                <tr key={service._id} className="border-t border-green-800">
                  ...
                  <td className="p-3 space-x-2 flex flex-col sm:flex-row">
                    <button onClick={() => setEditingService(service)} className="bg-yellow-500 py-1 hover:bg-yellow-600 text-white px-4 rounded-full text-sm md:text-md mb-2 sm:mb-0">Update</button>
                    <button onClick={() => {
                      setDeleteId(service._id);
                      setShowDeleteModal(true);
                    }} className="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded-full text-sm md:text-md">Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
